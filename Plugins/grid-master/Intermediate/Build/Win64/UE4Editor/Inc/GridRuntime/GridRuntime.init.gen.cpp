...
void EmptyLinkFunctionForGeneratedCodeGridRuntime_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_GridRuntime()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_GridRuntime_GridNavAgentEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_GridRuntime_GridNavEventSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_GridRuntime_SeePawnEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_GridRuntime_SenseTestFunc__DelegateSignature,
			};
